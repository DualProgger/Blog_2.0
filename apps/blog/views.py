...
# библиотеки необходимые для древовидных комментариев
...
# создаем свои страницы ошибок 403, 404, 500
from django.shortcuts import render
...
class PostDetailView(DetailView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        # заголовок получаем из заголовка статьи
...
class PostCreateView(LoginRequiredMixin, CreateView):
    ...
    # перенаправление пользователя, если он не авторизован 
    # и пытается опубликовать пост
    login_url = 'home'
